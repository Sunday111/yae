...
- **git**, **CMake 3.29 or newer**, **Ninja** (the default generator), and a working C++ toolchain.
- **Python 3.12 or newer** on your `PATH`, for projects that stage content (`CopyDirectoriesAfterBuild`): the build
